...
import { IUserFriend, IUserFriendRequest, IUserWithProfile } from '@shared/libs/interfaces';
		...
		if (error instanceof HttpError) {
			...
			switch (error.statusCode) {
				...
				case 404:
					...
					break;
				case 409:
					message = 'Запрос на добавление в друзья к данному пользователю уже был отправлен ранее.';
					break;
			}
