...
import { ISettingsNavigationGroupProps } from '../lib/settings-navigation-group.interface.ts';
import styles from './SettingsNavigationGroup.module.scss';

const SettingsNavigationGroup: FC<ISettingsNavigationGroupProps> = ({ title, items }) => {
	return (
