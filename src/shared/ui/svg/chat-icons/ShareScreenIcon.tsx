...
const ShareScreenIcon: FC<IconProps> = ({ className, itemClassName }) => {
	return (
		<svg
		...
		>
			...
			<g>
				...
				<path d='M17 8l5-5' className={itemClassName} />
				<path d='M17 3h5v5' className={itemClassName} />
			</g>
		</svg>
	);
};

export { ShareScreenIcon };
